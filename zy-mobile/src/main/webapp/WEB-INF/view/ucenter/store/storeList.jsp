...
<%--&lt;%&ndash;<a href="${ctx}/u/productReplacement/create" class="button-right"><i class="fa fa-edit"></i>换货</a>&ndash;%&gt;--%>
<%--</header>--%>
...
<%--&lt;%&ndash;<li<c:if test="${orderStatus == '已退款'}"> class="current"</c:if>><a href="${ctx}/u/order/${inOut}?orderStatus=5">已退款 (${orderCount5})</a></li>&ndash;%&gt;--%>
