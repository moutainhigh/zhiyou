...
<%--<article>--%>
  <%--<form action="${ctx}/u/order/deliver" class="valid-form" method="post">--%>
    ...
    <%--<div id="logistics" class="list-group hide">--%>
      <%--&lt;%&ndash;<div class="list-title">请填写您的物流信息</div>&ndash;%&gt;--%>
      <%--&lt;%&ndash;<div class="list-item">&ndash;%&gt;--%>
      <%--&lt;%&ndash;<label class="list-label" for="logisticsName">物流公司名</label>&ndash;%&gt;--%>
      <%--&lt;%&ndash;<div class="list-text">&ndash;%&gt;--%>
      <%--&lt;%&ndash;<input type="text" name="logisticsName" class="form-input" value="" placeholder="填写物流公司名">&ndash;%&gt;--%>
      <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
      <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
      <%--&lt;%&ndash;<div class="list-item">&ndash;%&gt;--%>
      <%--&lt;%&ndash;<label class="list-label" for="logisticsSn">物流单号</label>&ndash;%&gt;--%>
      <%--&lt;%&ndash;<div class="list-text">&ndash;%&gt;--%>
      <%--&lt;%&ndash;<input type="text" name="logisticsSn" class="form-input" value="" placeholder="填写物流单号">&ndash;%&gt;--%>
      <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
      <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
      <%--<div class="list-item">--%>
