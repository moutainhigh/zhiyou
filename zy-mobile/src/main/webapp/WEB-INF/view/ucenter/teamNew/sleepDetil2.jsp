    ...
    <div class="rankingAllList">
        <div class="rankingAll">
            ...
            <div class="ranking rankingNew">
                ...
                <span class="rankingSpan {{ d.userRank =='V4'?'must':d.userRank =='V3'?'province':d.userRank =='V2'?'city':d.userRank =='V1'?'VIP':d.userRank=='V0'?'com':''}}">{{d.userRank =='V4'?'联合创始人':d.userRank =='V3'?'品牌合伙人':d.userRank =='V2'?'品牌经理':d.userRank =='V1'?'VIP':d.userRank =='V0'?'普通用户':''}}</span>
            </div>
