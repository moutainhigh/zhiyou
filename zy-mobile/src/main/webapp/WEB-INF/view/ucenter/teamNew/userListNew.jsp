...
<article>
  <c:if test="${dataMap.flag != null}">
    <div class="all" >
      <div class="teamAll">
        ...
        <c:if test="${dataMap.flag eq 'T'}"> <a href="${ctx}/u/team/findDirectlySup?productType=${product.productType}">直属特级详情>></a></c:if>
      </div>
  ...
  <div class="all" >
    <div class="teamAll">
      ...
      <span>直属团队</span>
      <a href="${ctx}/u/team/teamDetail?productType=${product.productType}">直属详情>></a>
    </div>
  ...
  <div class="all" >
    <div class="teamAll">
      ...
      <span>团队新成员</span>
      <a href="${ctx}/u/team/teamNew?productType=${product.productType}">新成员详情>></a>
    </div>
  ...
  <div class="all allLast">
    ...
    <a href="${ctx}/u/team/teamSleep?productType=${product.productType}" class="lookDetil">查看详情>></a>
  </div>
</article>
