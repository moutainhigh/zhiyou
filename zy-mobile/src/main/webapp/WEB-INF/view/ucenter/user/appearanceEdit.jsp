...
<body class="header-fixed">
  ...
  <article>
    <form action="${ctx}/u/appearance/edit" class="valid-form" method="post">
      <div class="list-group mt-10">
        <div class="list-item">
          <label class="list-label">姓名</label>
          <div class="list-text">
            <input type="text" id="realname" name="realname" class="form-input" value="${appearance.realname}" placeholder="填写真实姓名">
          </div>
        </div>
        <div class="list-item">
          <label class="list-label">身份证号</label>
          <div class="list-text">
            <input type="text" id="idCardNumber" name="idCardNumber" class="form-input" value="${appearance.realname}" placeholder="填写身份证号">
          </div>
        </div>
      </div>
