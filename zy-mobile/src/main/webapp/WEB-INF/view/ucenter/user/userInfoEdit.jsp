...
<body>
  ...
  <article>
    <form action="${ctx}/u/userInfo/edit" class="valid-form" method="post">
      <div class="list-group mt-10">
        ...
        <div class="list-item">
          ...
          <div class="list-text form-select">
            <select name="gender">
              ...
              <option value="0" <c:if test="${userInfo.gender eq '男'}"> selected</c:if>>男</option>
              <option value="1" <c:if test="${userInfo.gender eq '女'}"> selected</c:if>>女</option>
            </select>
          </div>
        </div>
        <div class="list-item">
        ...
        <div class="list-item">
          ...
          <div id="tagWrap" class="list-text tag-wrap pt-5">
            ...
            <input type="hidden" id="tagIds" name="tagIds" value="${userInfo.tagIds}">
          </div>
          <i class="i-arrow"></i>
        </div>
      </div>
        ...
        <div class="list-item">
          ...
          <div class="list-text image-upload">
            <div class="image-item image-single">
              ...
              <img src="${userInfo.image1Thumbnail}">
              <input type="file">
            </div>
          </div>
          <div class="list-unit">
        ...
        <div class="list-item">
          ...
          <div class="list-text image-upload">
            <div class="image-item image-single">
              ...
              <img src="${userInfo.image2Thumbnail}">
              <input type="file">
            </div>
          </div>
          <div class="list-unit">
