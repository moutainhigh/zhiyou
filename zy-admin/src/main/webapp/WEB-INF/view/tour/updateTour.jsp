...
<script type="text/javascript">
    //编辑器
    var ue;
    var articleContent = '${tour.content}';
    $(function() {
...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li><a href="javascript:;" data-href="${ctx}/article">旅游管理</a></li>
    </ul>
</div>
<!-- END PAGE HEADER-->
    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form id="createForm"action="" data-action="${ctx}/tour/update"  class="form-horizontal" method="post">
