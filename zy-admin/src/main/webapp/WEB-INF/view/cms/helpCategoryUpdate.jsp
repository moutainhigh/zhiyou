	...
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-plus-circle"></i><span> 编辑帮助归类</span>
				</div>
				<div class="tools">
							...
							<div class="col-md-5">
								<div class="input-icon right">
									<select name="userType" id="userType" class="form-control">
					               		...
					               		<option value="0"<c:if test="${helpCategory.userType == '商家' }"> selected="selected"</c:if>>商家</option>
					               		<option value="1"<c:if test="${helpCategory.userType == '试客' }"> selected="selected"</c:if>>试客</option>
					                  </select>
								</div>
							</div>
						</div>
