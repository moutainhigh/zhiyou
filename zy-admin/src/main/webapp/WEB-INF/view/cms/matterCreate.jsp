  ...
  <div class="col-md-12">
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption">
          <i class="icon-arrow-down"></i> 创建资源
        </div>
        <div class="tools">
      ...
      <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form id="form" action="" data-action="${ctx}/matter/create" class="form-horizontal" method="post">
          <div class="form-body">
            ...
            <input id="matterUrl" type="hidden" name="url" value=""/>
          </div>
