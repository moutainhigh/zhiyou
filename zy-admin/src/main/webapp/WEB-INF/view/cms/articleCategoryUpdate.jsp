  ...
  <div class="col-md-12">
    ...
    <div class="portlet box yellow">
      <div class="portlet-title">
        <div class="caption">
          <i class="fa fa-edit"></i><span> 文章类别编辑 </span>
        </div>
        <div class="tools">
      ...
      <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form id="createForm" action="" data-action="${ctx}/articleCategory/update" class="form-horizontal" method="post">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
				 <select name="isVisiable" class="form-control">
				 	...
				 	<option value="true"<c:if test="${articleCategory.isVisiable}"> selected="selected"</c:if> >--是--</option>
				 	<option value="false"<c:if test="${!articleCategory.isVisiable}"> selected="selected"</c:if>>--否--</option>
				 </select>
              </div>
            </div>
