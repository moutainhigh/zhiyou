...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li><a href="javascript:;" data-href="${ctx}/help/${help.helpCategoryId}">帮助管理</a></li>
	</ul>
</div>
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12">
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-plus-circle"></i><span> 编辑帮助</span>
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<form id="createForm" action="" data-action="${ctx}/help/update" class="form-horizontal" method="post">
					<input type="hidden" name="helpCategoryId" value="${help.helpCategoryId}"/>
					...
					<div class="form-actions fluid">
						<div class="col-md-offset-3 col-md-9">
							...
							<button class="btn default" data-href="${ctx}/help/${help.helpCategoryId}">
