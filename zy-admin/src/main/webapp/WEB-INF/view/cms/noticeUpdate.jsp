	...
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-plus-circle"></i><span> 编辑公告</span>
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<form id="createForm" action="" data-action="${ctx}/notice/update" class="form-horizontal" method="post">
								...
								<div class="input-icon right">
									<select name="noticeType" id="noticeType" class="form-control">
					               		...
					               		<c:forEach items="${noticeTypes}" var="noticeType" >
					               			<option value="${noticeType}" <c:if test="${noticeType == notice.noticeType}"> selected="selected"</c:if>>${noticeType}</option>
					               		</c:forEach>
					                  </select>
								</div>
							</div>
