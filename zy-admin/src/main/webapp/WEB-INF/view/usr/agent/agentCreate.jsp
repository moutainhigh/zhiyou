  ...
  <div class="col-md-12">
    ...
    <div class="portlet box yellow">
      ...
      <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form id="updateForm" action="" data-action="${ctx}/agent/create" class="form-horizontal" method="post">
          <div class="form-body">
            ...
            <div class="form-group">
              <label class="control-label col-md-3">邀请人手机号
              </label>
              <div class="col-md-4">
                <div class="input-icon right">
                  <i class="fa fa-phone"></i> 
                  <input type="text" id="inviterPhone" class="form-control" name="inviterPhone" value="" placeholder="请输入合伙人手机号"/>
                </div>
              </div>
            </div>
          ...
          <div class="form-actions fluid">
            <div class="col-md-offset-3 col-md-9">
              ...
              <button class="btn default" data-href="${ctx}/agent">
