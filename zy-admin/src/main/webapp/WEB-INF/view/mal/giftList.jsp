...
<script>
			...
			dataTable: {
				...
				columns: [
					...
					},
					{
						...
						orderable: false,
						render: function (data, type, full) {
							var optionHtml = '<a class="btn btn-xs default yellow-stripe" href="javascript:;" data-href="${ctx}/gift/update/' + full.id + '"><i class="fa  fa-mail-forward"></i> 编辑 </a>';
							if (full.isOn) {
	...
	function operation(id, isOn) {
		$.post('${ctx}/gift/on', {id: id, isOn: isOn}, function (result) {
