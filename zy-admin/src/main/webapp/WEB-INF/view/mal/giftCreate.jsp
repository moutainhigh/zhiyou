...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li><a href="javascript:;" data-href="${ctx}/gift">礼品管理</a></li>
  </ul>
</div>
<!-- END PAGE HEADER-->
  ...
  <div class="col-md-12">
    ...
    <div class="portlet box yellow">
      <div class="portlet-title">
        <div class="caption">
          <i class="fa fa-edit"></i><span> 新增礼品</span>
        </div>
        <div class="tools">
      ...
      <div class="portlet-body form">
        ...
        <!-- BEGIN FORM-->
        <form id="createForm" action="" data-action="${ctx}/gift/create" class="form-horizontal" method="post">
          <div class="form-body">
            ...
            <div class="form-group">
              <label class="control-label col-md-3">锁定数量<span class="required"> * </span>
              </label>
              <div class="col-md-4">
