    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form id="form" action="" data-action="${ctx}/lesson/create" class="form-horizontal" method="post">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" name="title" id="title" value="" placeholder="请填入课程名称"/>
                            </div>
                        </div>
