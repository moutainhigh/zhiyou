...
<script>
  ...
  function reportExport() {
    location.href = '${ctx}/report/order/daily/export?queryDate=${queryDate}&' + $('#searchForm').serialize();
  }
  </shiro:hasPermission>
...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li><a href="javascript:;" data-href="${ctx}/report/order">服务商进货(日)报表</a></li>
  </ul>
</div>
<!-- END PAGE HEADER-->
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right">
                  <c:forEach items="${queryTimeLabels}" var="queryTimeLabel">
                    <li>
                        <a data-href="${ctx}/report/order/daily?queryDate=${queryTimeLabel}"> ${queryTimeLabel}
                        </a>
                    </li>
                  </c:forEach>
                </ul>
