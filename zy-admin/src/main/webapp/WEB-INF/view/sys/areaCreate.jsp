  ...
  <div class="col-md-12">
    ...
    <div class="portlet light bordered">
      ...
      <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form id="dataForm" action="" data-action="${ctx}/area/create" class="form-horizontal" method="post">
          <input type="hidden" name="parentId" value="${area.id}"/>
          <div class="form-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-5">
              	<input type="text" class="form-control" id="orderNumber" name="orderNumber" value="" />
              </div>
            </div>
