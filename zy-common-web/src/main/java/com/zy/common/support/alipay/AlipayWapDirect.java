...
public class AlipayWapDirect {
	...
	public AlipayWapDirect(String bargainorId, String bargainorKey) {
	...
	public Map<String, String> getParameterMap(String paymentSn, BigDecimal paymentAmount, String title, String merchantName, String productUrl,
		...
		String service = "alipay.wap.create.direct.pay.by.user";// 接口类型（alipay.wap.create.direct.pay.by.user：手机网站即时交易）
	...
	public boolean verifySign(HttpServletRequest request) {
		...
		String service = request.getParameter("service"); // fix wap
