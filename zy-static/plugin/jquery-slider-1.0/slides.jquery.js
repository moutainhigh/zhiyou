...
(function($){
	$.fn.slides = function( option ) {
		...
		return this.each(function(){
			...
			//增加焦点切换按钮
			var liLength = $(".slides_container li").length;
			var ulHtml="";
			ulHtml +='<ul class="slides-pagination">';
			for(var i=0; i<liLength; i++){
				ulHtml +='<li> <a href="#" rel="'+i+'"></a> </li>';
			}
			ulHtml +='</ul>';
			$(".visual").append(ulHtml);
			...
			$('.' + option.paginationClass + ' li a', elem ).click(function(){
				...
				if (current != clicked) {
					animate('slides-pagination', paginationEffect, clicked);
				}
				return false;
			});
	...
	$.fn.slides.option = {
		...
		paginationClass: 'slides-pagination', // string, Class name for pagination
