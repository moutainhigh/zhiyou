...
public class Article implements Serializable {
	...
	public static final String VO_ADMIN = "ArticleAdminVo";
	public static final String VO_LIST = "ArticleListVo";
	public static final String VO_DETAIL = "ArticleDetailVo";
