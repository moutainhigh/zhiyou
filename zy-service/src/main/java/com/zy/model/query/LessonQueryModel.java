...
@NoArgsConstructor
@AllArgsConstructor
public class LessonQueryModel implements Serializable {

	private String titleLK;

	private Integer lessonLevelEQ;

	private String[] parentAllIdIN;

	private Long createByIdEQ;

	private Date createDateGTE;

	private Date createDateLT;

	private Integer viewFlageEQ;
	...
	static {
		fieldNames.add("parentAllId");
		fieldNames.add("createById");
		fieldNames.add("id");
		fieldNames.add("title");
		fieldNames.add("lessonLevel");
		fieldNames.add("viewFlage");
