...
@NoArgsConstructor
@AllArgsConstructor
public class ArticleCategoryQueryModel implements Serializable {

	private Long parentIdEQ;

	private Boolean isTopParentEQ;

	private Boolean isVisiableEQ;
	...
	static {
		...
		fieldNames.add("id");
		fieldNames.add("indexNumber");
		fieldNames.add("parentId");
		fieldNames.add("isTopParent");
		fieldNames.add("isVisiable");
	}
