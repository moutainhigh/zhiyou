...
@NoArgsConstructor
@AllArgsConstructor
public class ProductReplacementQueryModel implements Serializable {

	private Long userIdEQ;

	private Long[] userIdIN;

	private ProductReplacementStatus productReplacementStatusEQ;

	private String fromProductLK;

	private String toProductLK;
	...
	static {
		...
		fieldNames.add("fromProduct");
		fieldNames.add("quantity");
		fieldNames.add("receiverProvince");
		fieldNames.add("remark");
		fieldNames.add("productReplacementStatus");
