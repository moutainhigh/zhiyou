...
@NoArgsConstructor
@AllArgsConstructor
public class NewReportTeamQueryModel implements Serializable {

	private Long idEQ;

	private String provinceNameLK;
	...
	private Integer numberEQ;

	private Integer rankEQ;

	private Integer rankChangeEQ;
