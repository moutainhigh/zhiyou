...
@NoArgsConstructor
@AllArgsConstructor
public class ReportLogQueryModel implements Serializable {
	...
	private ConfirmStatus reportPreConfirmStatusEQ;

	private ConfirmStatus reportConfirmStatusEQ;
	...
	static {
		fieldNames.add("reportConfirmStatus");
		fieldNames.add("reportId");
		fieldNames.add("createdTime");
		fieldNames.add("reportPreConfirmStatus");
