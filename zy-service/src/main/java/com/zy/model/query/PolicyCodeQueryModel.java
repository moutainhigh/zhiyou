...
@NoArgsConstructor
@AllArgsConstructor
public class PolicyCodeQueryModel implements Serializable {

	private Long idEQ;

	private String codeLK;
	...
	private Date usedTimeGTE;

	private Date usedTimeLT;

	private Boolean isUsedEQ;

	private String batchCodeEQ;
	...
	static {
		fieldNames.add("usedTime");
		fieldNames.add("code");
		fieldNames.add("batchCode");
