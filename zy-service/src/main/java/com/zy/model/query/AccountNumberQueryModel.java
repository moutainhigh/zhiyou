...
@NoArgsConstructor
@AllArgsConstructor
public class AccountNumberQueryModel implements Serializable {

	private String oldPhoneEQ;

	private String newPhoneEQ;

	private String flageEQ;

	private String[] flageIN;
