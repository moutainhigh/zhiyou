...
@NoArgsConstructor
@AllArgsConstructor
public class LessonUserQueryModel implements Serializable {

	private Long lessonIdEQ;

	private Long userIdEQ;

	private Integer lessonStatusEQ;
	...
	static {
		fieldNames.add("lessionId");
		fieldNames.add("lessionStatus");
